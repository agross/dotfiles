...
FAST_HIGHLIGHT_STYLES[for-loop-number]='fg=green,bold'
FAST_HIGHLIGHT_STYLES[for-loop-variable]='fg=green,bold'
...
if [[ "$(echotc Co)" == '256' ]]; then
  ...
  FAST_HIGHLIGHT_STYLES[for-loop-variable]='fg=112' # Green.
  FAST_HIGHLIGHT_STYLES[mathnum]='fg=112' # Green.
